...
CREATE TABLE IF NOT EXISTS Weapon (
	Weapon_ID INT UNIQUE NOT NULL PRIMARY KEY,
    Weapon_Name VARCHAR(255) NOT NULL,
	Weapon_Strength INT NOT NULL
);

CREATE TABLE IF NOT EXISTS Clan (
	Clan_ID INT UNIQUE NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS Armour (
	Armour_ID INT UNIQUE NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS CharType (
	CharType_ID INT UNIQUE NOT NULL PRIMARY KEY,
    CharType_Name VARCHAR(255) NOT NULL,
    CharType_Weakness VARCHAR(255)
);

CREATE TABLE IF NOT EXISTS Stats (
	Stats_ID INT UNIQUE NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS UserInfo (
	UserInfo_ID INT UNIQUE NOT NULL PRIMARY KEY,
    UserInfo_FName VARCHAR(255) NOT NULL,
	UserInfo_LName VARCHAR(255) NOT NULL,
	UserInfo_Username VARCHAR(255) UNIQUE NOT NULL,
...
CREATE TABLE IF NOT EXISTS UserCharacter (
	UserCharacter_ID INT UNIQUE NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS EnemyCharacter (
	EnemyCharacter_ID INT UNIQUE NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS CharacterWeapon (
	CharacterWeapon_ID INT UNIQUE NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS CharacterArmour (
	CharacterArmour_ID INT UNIQUE NOT NULL PRIMARY KEY,
    UserCharacter_ID INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS UserChar (
	UserChar_ID INT UNIQUE NOT NULL PRIMARY KEY,
    UserCharacter_ID INT NOT NULL,
...
#update password and character name
#delete users and characters
